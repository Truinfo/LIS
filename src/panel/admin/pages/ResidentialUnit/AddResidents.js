...
const AddResidents = () => {
    ...
    const handleVerifyOtp = async () => {
        try {
            ...
            const resultAction = await dispatch(verifyOTP({ email, otp: otpValue })).unwrap();
        ...
        <KeyboardAvoidingView style={styles.container} behavior="padding" keyboardVerticalOffset={80}>
            <ScrollView contentContainerStyle={styles.form}>
                ...
                <TextInput
                    ...
                    value={phoneNumber}
                    theme={{ colors: { primary: "#7d0431" } }}
                    onChangeText={(text) => validatePhoneNumber(text.replace(/[^0-9]/g, ''))}
                ...
                {isVerified && (<Text style={{ color: "green", marginLeft: 10 }}>
                    Verified
                </Text>
                )}
                {isOtpVisible && (
                    <>
                        ...
                        <TouchableOpacity style={styles.verifyText} onPress={handleVerifyOtp}>
                ...
                <View style={styles.radioContainer}>
                    <RadioButton.Group onValueChange={setUserType} value={userType}>
                        <View style={styles.radioButtonRow}>
                            <RadioButton.Item label="Tenant" value="Tenant" theme={{ colors: { primary: "#7d0431" } }} />
                            <RadioButton.Item label="Owner" value="Owner" theme={{ colors: { primary: "#7d0431" } }} />
                        </View>
                    </RadioButton.Group>
                </View>
